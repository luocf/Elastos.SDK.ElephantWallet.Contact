...
public:
    ...
    int pullData(const char* friendCode, int chType, const char* devId, const char* dataId);
    int cancelPullData(const char* friendCode, int chType, const char* devId, const char* dataId);
